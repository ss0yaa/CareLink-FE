          ...
          <>
            <div className='flex flex-col gap-2.5'>
              ...
              <input
                ...
                className='px-[25px] py-[17px] font-semibold text-[18px] bg-white rounded-[10px] border-[1.50px] border-[#B3B3B3]'
              />
            </div>
            <div className='flex flex-col gap-2.5 mt-[30px]'>
              ...
              <button
                type='button'
                onClick={handleModal}
                className='flex flex-row justify-between px-[25px] py-[17px] font-semibold text-[18px] bg-white rounded-[10px] border-[1.50px] border-[#B3B3B3] text-[#B3B3B3] cursor-pointer'
              >
                <p>시간을 선택해주세요.</p>
                <img src={IconSelect} />
              </button>
            ...
            <button
              type='button'
              onClick={() => onSave(item.id, { name, time })}
